...
-- Create or clear an autocommand group
local group = vim.api.nvim_create_augroup("MySettings", { clear = true })

-- Enforce settings when any buffer is opened or a new file is created
...
vim.api.nvim_create_user_command('Code', 'silent !code %:p', {})
...

  {
    ...
    config = function()
      require('tokyonight').setup({
        ...
        transparent = true, -- Enable or disable transparent background
        ...
        -- PmenuSel = "#FF0000", -- can't figure this out here, see line 70 in lua/tokyonight/theme.lua. popupmenu select
...
--[[ -- START test commentout complete annoyance interference with copilot
-- nvim-cmp supports additional completion capabilities, so broadcast that to servers
local capabilities = vim.lsp.protocol.make_client_capabilities()
capabilities = require('cmp_nvim_lsp').default_capabilities(capabilities)
--]]
--END test commentout complete annoyance interference with copilot
...
--[[ --START COMMENT OUT OLD AUTO COMPLETE
--  Configure nvim-cmp
-- See `:help cmp`
-- local cmp = require 'cmp' -- commented this out, experimenting with getting rid of annoying complete annoyance
...
--]]
--END COMMENT OUT OLD AUTO COMPLETE
